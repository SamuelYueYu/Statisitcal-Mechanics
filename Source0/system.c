...
double VanishTime[MAX_NumberOfParticles];
int EscapeID;
int VanishID;
...
double Virial,VirialLeft,VirialRight; //Virial values
...
double muA,muB,sigmaV; // chemical potentials
...
double MFPL,MFPR; // particle mean free path in left & right chambers
double Kn[4]; // Knudsen number
