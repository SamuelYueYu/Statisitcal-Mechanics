...
extern double xAM,xBM; // fraction of both types upstream membrane
extern double yAM,yBM; // fraction of both types downstream membrane
...
extern double Virial,VirialLeft,VirialRight,VirialLeftMem,VirialRightMem; // Virial values
...
extern double mu1,mu2; // chemical potentials
...
extern double pLeftMemVirial, pRightMemVirial;
...
extern double pALM, pBLM, pARM, pBRM; // partial pressures
extern double MFPLA_p, MFPRA_p, MFPLB_p, MFPRB_p; // particle mean free path in left & right chambers
extern double MFPLA_rho, MFPRA_rho, MFPLB_rho, MFPRB_rho; // particle mean free path in left & right chambers
extern double MFPLMA_p, MFPRMA_p, MFPLMB_p, MFPRMB_p;
extern double MFPLMA_rho, MFPRMA_rho, MFPLMB_rho, MFPRMB_rho;
extern double KnA_p[4], KnB_p[4]; // Knudsen number
extern double KnA_rho[4], KnB_rho[4];
/**************************************************/
